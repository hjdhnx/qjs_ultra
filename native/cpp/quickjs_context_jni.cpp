/*
 * quickjs_context_jni.cpp - QuickJS 上下文 JNI 接口实现
 *
 * 实现 Java 层 QuickJSContext 类对应的 JNI 方法，
包括 eval、call、getProperty、setProperty 等操作。
 *
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_whl_quickjs_wrapper_QuickJSContext_contains(JNIEnv *env, jobject clazz, jlong context,
                                                                jlong object_handle, jstring key) {
    auto wrapper = reinterpret_cast<QuickJSWrapper*>(context);
    return wrapper->contains(env, object_handle, key);
}

extern "C"
JNIEXPORT jobjectArray JNICALL
Java_com_whl_quickjs_wrapper_QuickJSContext_getKeys(JNIEnv *env, jobject clazz, jlong context,
                                                                jlong object_handle) {
    auto wrapper = reinterpret_cast<QuickJSWrapper*>(context);
    return wrapper->getKeys(env, object_handle);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_whl_quickjs_wrapper_QuickJSContext_arrayAdd(JNIEnv *env, jobject thiz, jlong context,
                                                                jlong object_handle, jobject value) {
    auto wrapper = reinterpret_cast<QuickJSWrapper*>(context);
    wrapper->arrayAdd(env, thiz, object_handle, value);
}
